...
Feature: Grades are fetched automatically from the referenced course
  ...
  @javascript
  Scenario: Grade is immediately copied from a subcourse to the master course for Moodle ≥ 4.0
  ...
  @javascript
  Scenario: Grade is immediately copied from a subcourse to the master course for Moodle ≤ 3.11
