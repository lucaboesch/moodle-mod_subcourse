...
Feature: Grades can be fetched either a real values or as percentages
  ...
  Scenario: Fetch percentage grades from subcourse in Moodle ≥ 4.0
  ...
  Scenario: Fetch percentage grades from subcourse in Moodle ≤ 3.11
  ...
  @javascript
  Scenario: Grades are fetched as real values by default in Moodle ≥ 4.0
    Given the site is running Moodle version 4.0 or higher
    And the following "users" exist:
      | username      | firstname | lastname  | email                |
      | teacher1      | Teacher   | 1         | teacher1@example.com |
  ...
  @javascript
  Scenario: Grades are fetched as real values by default in Moodle ≤ 3.11
    Given the site is running Moodle version 3.11 or lower
    And the following "users" exist:
      | username      | firstname | lastname  | email                |
      | teacher1      | Teacher   | 1         | teacher1@example.com |
  ...
  @javascript
  Scenario: Grades can be fetched as percentual values in Moodle ≥ 4.0
    Given the site is running Moodle version 4.0 or higher
    And the following "users" exist:
      | username      | firstname | lastname  | email                |
      | teacher1      | Teacher   | 1         | teacher1@example.com |
  ...
  @javascript
  Scenario: Grades can be fetched as percentual values in Moodle ≤ 3.11
    Given the site is running Moodle version 3.11 or lower
    And the following "users" exist:
      | username      | firstname | lastname  | email                |
      | teacher1      | Teacher   | 1         | teacher1@example.com |
