...
Feature: Progress and grade in referenced course can be displayed on the course main page
  ...
  @javascript
  Scenario: Progress and grade displayed on both course main page and subcourse view page in Moodle ≥ 4.0
  ...
  @javascript
  Scenario: Progress and grade displayed on both course main page and subcourse view page in Moodle ≤ 3.11
  ...
  @javascript
  Scenario: Progress and grade displayed on subcourse view page only in Moodle ≥ 4.0
    Given the site is running Moodle version 4.0 or higher
    And the following "users" exist:
      | username      | firstname | lastname  | email                |
      | teacher1      | Teacher   | 1         | teacher1@example.com |
  ...
  @javascript
  Scenario: Progress and grade displayed on subcourse view page only in Moodle ≤ 3.11
    Given the site is running Moodle version 3.11 or lower
    And the following "users" exist:
      | username      | firstname | lastname  | email                |
      | teacher1      | Teacher   | 1         | teacher1@example.com |
