...
$string['settings:limittoenrolled'] = 'Limit to courses the trainer is enrolled to';
$string['settings:limittoenrolled_desc'] = 'This shows only courses the trainer is enrolled to. Improves performance on big instances.';
